...
export function Navbar() {
  ...
  return (
    <div className="flex justify-center w-full z-50 px-4 lg:px-8">
      <div
        className="relative flex w-full max-w-[1686px] h-[99px] items-center gap-3 lg:gap-6 rounded-[60px] bg-white/90 px-4 lg:px-6 py-3 shadow-[0_6px_9px_4px_rgba(76,76,76,0.2)] backdrop-blur"
        style={{
          borderRadius: "60px",
